<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="AnnualInternalPerformanceReviewList.aspx.cs" Inherits="HRMS.AnnualInternalPerformanceReviewList" %>
                                                ...
                                                <asp:ListView ID="AnnualPerformanceListView" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="TableData">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblProjectType" runat="server" Text='<%# Eval("Name")%>'> </asp:Label>
                                                            </td>
                                                            <td>
