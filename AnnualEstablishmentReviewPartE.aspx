<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="AnnualEstablishmentReviewPartE.aspx.cs" Inherits="HRMS.AnnualEstablishmentReviewPartE" %>
            ...
            <div class="col-lg-12 col-md-12 model-box">
                ...
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p class="NewEntry">Annual Establishment Review  Part - E (Outsourced/on contract)</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            <div class="row md-12 marginx">
                                ...
                                <div class="col-md-12">
                                    <asp:Button ID="btnSubmit" CssClass="btn-s float-right submit btn-yellow"
                                        OnClick="btnSubmit_Click" runat="server" type="submit" Text="Submit" />
                                </div>
                            </div>
                        </div>
                    </div>
