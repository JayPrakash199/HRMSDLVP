<%@ Page Title="" Language="C#" MasterPageFile="~/Fee.Master" AutoEventWireup="true" CodeBehind="DTETReport.aspx.cs" Inherits="HRMS.DTETReport" %>
            ...
            <div class="col-lg-12 col-md-12 model-box">
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p runat="server" id="Divreport" class="NewEntry">DTET Report</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
