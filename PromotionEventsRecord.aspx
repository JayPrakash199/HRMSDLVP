<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="PromotionEventsRecord.aspx.cs" Inherits="HRMS.PromotionEventsRecord" %>
            ...
            <div class="col-lg-12 col-md-12 model-box">
                ...
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p class="NewEntry">Promotion Event Record</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
                                            ...
                                            <div class="col-md-6 contact-info">
                                                <div class="container">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlPromotionOrderIssuingAuthority" CssClass="form-control" runat="server">
