<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="AnnualEstablishmentReviewPartC.aspx.cs" Inherits="HRMS.AnnualEstablishmentReviewPartC" %>
            ...
            <div class="col-lg-12 col-md-12 model-box">
                ...
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p class="NewEntry">Annual Establishment Review  Part - C (Non-Regular Establishment)</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            <div class="row md-12 marginx">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleAccount">Category of employee (If any)</label>
                                        ...
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtPayScaleLevel7thPay" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <asp:Button ID="btnSubmit" Style="margin: 1%" runat="server" OnClick="btnSubmit_Click" CssClass="btn-s float-right submit btn-yellow"
