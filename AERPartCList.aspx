<%@ Page Title="" Language="C#" MasterPageFile="~/DefaultMasterPage.Master" AutoEventWireup="true" CodeBehind="AERPartCList.aspx.cs" Inherits="HRMS.AERPartCList" %>
                                                ...
                                                <asp:ListView ID="aerPartCListView" runat="server">
                                                    <LayoutTemplate>
                                                        <table runat="server" class="table table-bordered">
                                                            <tr
                                                                ...
                                                                <th runat="server">Pay Scale level 7th pay</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="TableData">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblProjectCode" runat="server" Text='<%# Eval("Employee_Catagory")%>'> </asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblProjectType" runat="server" Text='<%# Eval("Designation")%>'> </asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("Pay_Scale_level_7th_pay")%>'> </asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Persons_in_Position")%>'> </asp:Label>
                                                            </td>
                                                            <td>
