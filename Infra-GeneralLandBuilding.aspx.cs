...
namespace HRMS
{
    public partial class Infra_GeneralLandBuilding : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (lstUserRole != null)
                {
                    ...
                    string.Equals(x.Page_Name.Trim(), "General Land/Building Details", StringComparison.OrdinalIgnoreCase) &&
        ...
        //Added By Deshpande 03-04-2024
        protected bool AuthorizationCheck_Upload()
        {
            List<HRMSODATA.UserAuthorizationList> lstUserRole = ODataServices.GetUserAuthorizationList();
            if (lstUserRole != null)
            {
        ...
        protected bool AuthorizationCheck_Download()
        {
            List<HRMSODATA.UserAuthorizationList> lstUserRole = ODataServices.GetUserAuthorizationList();
            if (lstUserRole != null)
            {
        ...
        {
            bool IsAuthorized = AuthorizationCheck_Download();
            if (IsAuthorized)
        ...
        {
            bool isAuthorized = AuthorizationCheck_Upload();
            if (isAuthorized)
            {
