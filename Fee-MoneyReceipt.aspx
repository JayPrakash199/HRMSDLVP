<%@ Page Title="" Language="C#" MasterPageFile="~/Fee.Master" AutoEventWireup="true" CodeBehind="Fee-MoneyReceipt.aspx.cs" Inherits="HRMS.Fee_MoneyReceipt" %>
            ...
            <div class="col-lg-12 col-md-12 model-box">
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p class="NewEntry">Money Receipt</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
