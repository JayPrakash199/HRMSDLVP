            ...
            <div class="col-lg-12 col-md-12 model-box">
                ...
                <div class="col-lg-12 col-md-12 summary-box">
                    <div class="col-lg-12 NewEntrydiv">
                        <p class="NewEntry">Annual Establishment Review Part – A (Regular Establishment)</p>
                    </div>
                    <div class="row">
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleAccount">Pay Scale level 7th pay </label>
                                                    <asp:TextBox ID="txt7thPayScale" onkeypress="return isDecimalNumberKey(event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlDeptTrade" CssClass="form-control" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleAccount">Pay Scale GP</label>
                                                    <asp:TextBox ID="txtPayScaleGP" onkeypress="return isDecimalNumberKey(event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleAccount">Persons in Position</label>
                                                    <asp:TextBox ID="txtPersonsInPosition" onkeypress="return isDecimalNumberKey(event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleAccount">Employee Category</label>
                                                    <asp:DropDownList ID="ddlCategoryofEmployee" CssClass="form-control" runat="server">
