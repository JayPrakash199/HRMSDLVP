<%@ Page Title="" Language="C#" MasterPageFile="~/Fee.Master" AutoEventWireup="true" CodeBehind="CashBook.aspx.cs" Inherits="HRMS.CashBook" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                ...
                                                <div class="form-group tal" style="padding: 12px 0px;">
                                                    <label style="display: contents">Print Line Narration</label>
                                                    <asp:CheckBox ID="rdLineNarration" Checked="false" CssClass="chkboxReport" runat="server"></asp:CheckBox>
                                                </div>
                                                <div class="form-group tal" style="padding: 12px 0px;">
                                                    <label style="display: contents">Print Voucher Narration</label>
                                        ...
                                        <div class="col-md-6 contact-info">
                                            <div class="container">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtFromDate" CssClass="form-control ajax__calendar_body" type="date" runat="server"></asp:TextBox>
                                                </div>
                                                 <div class="form-group">
                                                    <label>To Date</label>
